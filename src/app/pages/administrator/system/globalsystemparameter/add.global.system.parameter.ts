...
@Component({
    ...
    template: `
        <!-- add-global-system-parameter.component.html -->
                ...
                <div class="card flex flex-col gap-6 w-full">
                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="flex flex-wrap gap-2 w-full">
                            ...
                            <p-select id="moduleName" name="moduleName" [(ngModel)]="globalSystemParameter.moduleName"
                                      [options]="dropdownModuleNameItems" optionLabel="name" optionValue="code"
                        ...
                        <div class="flex flex-wrap gap-2 w-full">
                            ...
                            <p-select id="fieldName" name="fieldName" [(ngModel)]="globalSystemParameter.fieldName"
                                      [options]="dropdownFieldItems" optionLabel="name" optionValue="code"
                                      placeholder="Select One" class="w-full"></p-select>
                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="flex flex-wrap gap-2 w-full">
                            ...
                            <input pInputText id="sysParCode" name="sysParCode" type="text" placeholder="Sys par code" [(ngModel)]="globalSystemParameter.sysParCode" />
                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="flex flex-wrap gap-2 w-full">
                            ...
                            <small *ngIf="gspForm.submitted && !globalSystemParameter.displayOrder" class="text-red-500">Order is required.</small>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="flex flex-wrap gap-2 w-full">
                            ...
                            <p-select id="status" name="status" [(ngModel)]="globalSystemParameter.sysParStatus"
                                      [options]="dropdownStatusItems" optionLabel="name" optionValue="code"
                                      placeholder="Select One" class="w-full"></p-select>
                        </div>
                    </div>
                    ...
                    <div class="card flex flex-wrap gap-0 w-full justify-end">
                        <p-buttongroup>
                            <p-button type="submit" label="Save" icon="pi pi-check" [disabled]="gspForm.invalid"></p-button>
...
export class AddGlobalSystemParameter implements OnInit {
    ...
    loadModuleFields(keyword: string = '') {
        this.moduleService.getModuleFields(keyword).subscribe({
