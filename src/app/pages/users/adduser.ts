            ...
            <p-fluid>
                <div class="card flex flex-col gap-6 w-full">
                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="flex flex-wrap gap-2 w-full">
                            ...
                            <input
                                ...
                                required
                                class="w-full"
                                [ngClass]="{ 'p-invalid': userForm.submitted && !user.name }"
                            />
                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="flex flex-wrap gap-2 w-full">
                            ...
                            <input
                                ...
                                required
                                class="w-full"
                                [ngClass]="{ 'p-invalid': userForm.submitted && !user.username }"
                            />
                        ...
                        <div class="flex flex-wrap gap-2 w-full">
                            ...
                            <div class="flex w-full items-center gap-2">
                                <input
                                    ...
                                    required
                                    class="flex-1"
                                    [ngClass]="{ 'p-invalid': userForm.submitted && !user.password }"
                                />
                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="flex flex-wrap gap-2 w-full">
                            ...
                            <input
                                ...
                                required
                                class="w-full"
                                [ngClass]="{ 'p-invalid': userForm.submitted && !user.email }"
                            />
                    ...
                    <div class="card flex flex-wrap gap-0 w-full justify-end">
                        <p-buttongroup>
                            <p-button type="submit" label="Save" icon="pi pi-check" [disabled]="userForm.invalid"/>
                            <p-button type="button" label="Cancel" icon="pi pi-times" (click)="goBack()"></p-button>
                        </p-buttongroup>
                    </div>
                </div>
            </p-fluid>
